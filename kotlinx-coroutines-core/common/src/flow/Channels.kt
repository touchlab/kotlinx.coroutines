 ...
 * 3) Failure of the flow collector does not affect the channel.
 *
 * ### Operator fusion
 *
 ...
 */
@FlowPreview // since 1.3.0, tentatively experimental/stable in 1.4.0
 ...
 * 2) Flow collector completes normally when the original channel completes (~is closed) normally.
